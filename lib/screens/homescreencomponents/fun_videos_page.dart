...
class FunVideosPage extends ConsumerStatefulWidget {
  ...
  @override
  ConsumerState<ConsumerStatefulWidget> createState() => _FunVideosPageState();
}

class _FunVideosPageState extends ConsumerState<FunVideosPage> {
  @override
  Widget build(BuildContext context) {
    ...
    debugPrint("FUN ${widget.posts?.length}");
